...
const BannerSection = () => {
  ...
  return (
    <>
      ...
      <div className="hidden max-w-[1370px] bg-[#E8EDF2] border mt-5 rounded mx-auto py-6">
        <div className="flex flex-col px-4 md:flex-row items-stretch justify-between gap-4 md:gap-6">
          <div className="flex-1 flex items-center justify-center md:justify-start gap-3 bg-white/0">
            <svg
          ...
          <div className="flex-1 flex items-center justify-center md:justify-start gap-3">
            <svg
              className="w-8 h-8 text-rose-500 flex-shrink-0"
              fill="none"
              stroke="currentColor"
              strokeWidth="1.5"
              viewBox="0 0 24 24"
      ...
      <div
        className="w-full max-w-[1370px] mx-auto mt-5 relative overflow-hidden rounded border bg-[#E8EDF2]"
        style={{ borderColor: "#F8CDB8" }}
      >
        {/* Shine Overlay */}
        <div className="absolute inset-0 bg-gradient-to-r from-transparent via-[#FDF2EC]/60 to-transparent bg-[length:200%_100%] animate-[shine_6s_linear_infinite]"></div>
        ...
        <div className="relative z-10 flex flex-nowrap overflow-x-auto md:overflow-visible whitespace-nowrap scrollbar-hide">
          {[
            ...
            <div
              key={i}
              className="relative flex items-center gap-3 px-5 md:py-3 py-1.5 min-w-max group"
            >
              {/* ICON */}
              <div
                className="w-9 h-9 bg-white rounded-md border border-gray-200 flex items-center justify-center overflow-hidden transition"
                onMouseEnter={(e) =>
              ...
              {/* TEXT */}
              <span
                className="text-gray-700 font-medium text-sm md:text-base transition whitespace-nowrap"
              ...
              {i !== 5 && (
                <div
                  className="absolute right-0 top-1/2 -translate-y-1/2 w-[1px] h-6 rotate-12"
