...
const AutoScrollingText = () => {
  return (
    <>
      ...
      <div
        className="lg:mx-auto lg:max-w-[1370px] mx-4
        overflow-hidden bg-gradient-to-r from-blue-100 via-blue-200 to-blue-100 py-2 px-4
       shadow-md rounded-md  backdrop-blur-sm bg-opacity-80"
      >
        <div
