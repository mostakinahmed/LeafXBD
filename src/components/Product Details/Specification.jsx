...
export default function ProductSpecTable({ data }) {
  ...
  return (
    <div className="font-sans bg-white rounded border border-slate-200 overflow-hidden shadow-md hover:shadow-lg transition-shadow duration-300">
      {/* Header */}
      <div className="relative overflow-hidden md:px-6  px-4 md:py-5 py-2 mt-1 md:-mb-2.5 ">
        ...
        {Object.entries(productSpecs)
          ...
          .map(([section, items]) => (
            <div key={section} className="flex flex-col">
              {/* Category Header */}
              <div className="bg-blue-50 md:px-6 px-4 py-3 border-y border-blue-100 first:border-t-0">
